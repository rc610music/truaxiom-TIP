...
const requiredPaths = [
  ...
  "packages/contracts/schemas/identity.schema.json",
  "packages/contracts/schemas/registry-entry.schema.json",
  "packages/contracts/schemas/agent-manifest.schema.json",
  "packages/contracts/schemas/workflow-definition.schema.json",
  "packages/contracts/workflows/WF-ROOTWORK-CONTENT-REVIEW.json",
  "packages/contracts/identities/SVC-ROOTWORK-CONTENT-INTELLIGENCE.json",
  ...
  "packages/core/src/approvedContentRecord.ts",
  ...
  "scripts/test-api-loop.mjs",
  "scripts/test-operator-review-gate.mjs",
  "scripts/test-approved-content-records.mjs",
  "scripts/test-rootwork-workflow.mjs",
  "database/schema.sql",
  ...
  "docs/sprints/SPRINT_001_FOUNDATION_REBASELINE_2026-08-27.md",
  "docs/adr/ADR-0004_Database_Free_Foundation.md",
